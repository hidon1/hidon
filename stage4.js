...
function showStage4Animation() {
  ...
  const events = [
    ...
    "הפיכת סדום ועמורה", "מכירת יוסף", "חלום פרעה ופתרונו", "יציאת מצרים", "קריעת ים סוף",
    ...
    "השמש בגבעון דום", "מלחמת סיסרא וברק", "שמשון הגיבור", "מלחמת פילגש בגבעה",
    "שאול נמשח למלך", "מלחמת שאול בעמלק", "דוד מול גוליית", "מרד אבשלום", "חורבן שילה",
    "גלות בית שומרון"
  ];
